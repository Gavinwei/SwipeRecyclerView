...
import com.gavin.recyclerview.touch.DefaultItemTouchHelper;
import com.gavin.recyclerview.touch.OnItemMoveListener;
import com.gavin.recyclerview.touch.OnItemMovementListener;
import com.gavin.recyclerview.touch.OnItemStateChangedListener;
import com.gavin.recyclerview.widget.DefaultLoadMoreView;
...
public class SwipeRecyclerView extends RecyclerView {
    ...
    private OnItemOpenCloseClickListener mOnItemOpenCloseClickListener;
    ...
    public void setOnItemOpenCloseClickListener(OnItemOpenCloseClickListener listener) {
        this.mOnItemOpenCloseClickListener = listener;
...
//                    Log.d("disX", "disX " + disX);
                    ...
                    if (mOnItemOpenCloseClickListener != null) {
                        mOnItemOpenCloseClickListener.onItemOpenCloseStatus(showLeftCloseRight,mOldSwipedLayout, touchPosition);
                    }
                }
